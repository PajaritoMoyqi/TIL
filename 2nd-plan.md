...
김동현, 『디버깅을 통해 배우는 리눅스 커널의 구조와 원리 1, 2』
박상현, 『이것이 자료구조+알고리즘이다 with C 언어』
서태원, 『원리부터 실무까지 쉽고 명확한 Arm 프로그래밍』
우치다 코타, 『0부터 시작하는 OS 자작 입문』
나카다 이쿠오, 『만들면서 배우는 컴파일러 첫걸음』
노암 니산·시몬 쇼켄, 『밑바닥부터 만드는 컴퓨팅 시스템』
유종원, 『컴파일러 만들기』
